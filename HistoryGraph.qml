    ...
    Canvas {
        ...
        onPaint: {
            ...
            for(var line=0;line<=4;line++){
                var y=8+(h-8)*line/4
                c.strokeStyle='#233039';c.lineWidth=1;c.beginPath();c.moveTo(x0,y);c.lineTo(x0+w,y);c.stroke()
                c.fillStyle='#7e959f';c.textAlign='right';c.fillText(Model.shortRate(root.ceiling*(1-line/4))+'/s',x0-4,y+3)
                c.fillStyle='#b48a5c';c.textAlign='left';c.fillText(Math.round(root.msCeiling*(1-line/4))+'ms',x0+w+4,y+3)
            }
            ...
            trace(4,'#f0ba82',1,yMs,true)
            trace(3,'#8d9dff',1.4,yRate,false)
            ...
            c.fillStyle='#7e959f';c.textAlign='left';c.fillText(root.historyData.seconds===3600?'1 hour ago':root.historyData.seconds===86400?'24 hours ago':'7 days ago',x0,height-3)
